 ...
 useEffect(() => {
  ...
  const defaultMessages = [
    ...
    },
    {
      ...
      email: "info@smartcorp.com",
      text: "Please review the latest updates on your project.",
      date: new Date().toISOString(),
    },
  ];

  const companyMessages = stored.length > 0 
    ? stored.filter(msg => msg.sender === "company") 
    : defaultMessages;
